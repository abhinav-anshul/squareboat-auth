      ...
      <div className='container mt-5 pt-4'>
        <div className='form_div'>
            ...
            <div className='roles_div mb-3'>
              <button
                className={
                  userRole === "Recruiter"
                    ? "primary_button mr-2"
                    : "primary_inactive_button mr-2"
                }
                onClick={() => setUserRole("Recruiter")}
              >
                <i className='fa fa-user-plus fa-lg'></i> Recruiter
              </button>
              <button
                className={
                  userRole === "Candidate"
              ...
              >
                <i className='fa fa-users fa-lg'></i> Candidate
              </button>
            </div>
          </div>
          ...
          <div className='text-center'>
            <p>
              Have an account?{" "}
              <Link to='/login' className='primary_text'>
                Login
              </Link>
            </p>
          </div>
